<?php 
    ...
    function load_stylesheets() {
        ...
        wp_enqueue_style('page-style', get_template_directory_uri() . '/assets/css/main.css', array('zyd-bootstrap'), $version, 'all');

        //bootstrap 5 css
        wp_enqueue_style('zyd-bootstrap',  'https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css', array(), '5.2', 'all');
    }
